...
<form id="form2" runat="server">
  ...
  <div id="containerconteudo">
    ...
    <div class="box_togheter">
      <ciac:listagemsimples id="together_banner" data_collection="collection_primary" runat="server"></ciac:listagemsimples>
    </div>
    ...
    <ciac:scriptrazor id="sampleBanner2" runat="server"></ciac:scriptrazor>
...
<!-- Template EGM STILUS - versão 01 - mantido por EGrupo Midia -->
</form>
</body>
</html>