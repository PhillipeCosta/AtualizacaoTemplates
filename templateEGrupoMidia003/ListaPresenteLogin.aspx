<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaPresenteLogin.aspx.cs" Inherits="CiaShop.Loja.Assets.Templates._1.ListaPresenteLogin" %><%@ Register Assembly="Ciashop.Privada.Componente" Namespace="Ciashop.Privada.Componente.Loja" TagPrefix="CiaC" %><%@ Register Src="ascx/Topo.ascx" TagName="Topo" TagPrefix="ciaL" %><%@ Register Src="ascx/Rodape.ascx" TagName="Rodape" TagPrefix="ciaL" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
  ...
  <div id="containerconteudo">
      ...
      <div id="conteudo" class="conteudo_fixo">
         <h1 class="titulo_pedido">
          ...
          <div class="lista_login_conteudo">
            <div class="respiro">
