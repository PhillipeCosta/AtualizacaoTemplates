...
<form id="form2" runat="server">
    ...
    <section class="container containerContent10 main-container">
      ...
      <div class="ciashop-titBox heading-primary">
        <h2>Dúvidas&nbsp;<span class="fa fa-question"></span></h2>      
        <span class="ciashop-cantoTit"></span>      
        <hr>
      </div>      
      <ciac:duvidas id="Duvidas" runat="server"></ciac:duvidas>
      <!-- Fale Conosco -->
      <div class="ciashop-titBox heading-primary">
        <h2>Fale Conosco&nbsp;<span class="fa fa-comment"></span></h2>      
        <span class="ciashop-cantoTit"></span>      
        <hr>
      </div>      
      <ciac:faleconosco id="FaleConosco" runat="server"></ciac:faleconosco>  
    </section>
    <footer>
