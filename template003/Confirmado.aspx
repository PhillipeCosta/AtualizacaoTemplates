...
<form id="form2" runat="server">
  ...
  <div class="banner banner-full">
    ...
    <div class="col-md-12 cart-container">
          <h4 class="text-uppercase text-left heading-primary custom-paddingV20"><strong>Pedido confirmado</strong></h4> 
      		<ciac:scriptrazor id="ebitBanner" runat="server"></ciac:scriptrazor>  
            <div class="custom-paddingV10 custom-overflow">
            ...
            <div class="custom-paddingV10 custom-overflow">
              <h5 class="text-uppercase text-left heading-primary custom-paddingV20"><strong>Confira seu pedido</strong></h5> 
