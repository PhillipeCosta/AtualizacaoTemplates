...
<form id="form2" runat="server">
    ...
    <div class="container main-container">
      ...
      <div class="col-xs-12 custom-clearPadding custom-paddingV10">
          ...
          <div class="pull-right custom-clearPadding custom-paddingV10">
            <div style="width: 155px;">
              <div class="banner">
                <ciac:banner id="rightColumn" runat="server"></ciac:banner>
              </div>
          ...
          <div class="custom-overflow">
            ...
            <div class="banner text-center">
              <ciac:banner id="leftLow" runat="server"></ciac:banner>
            </div>          
          </div>        
      </div>
    </div>
