  ...
  <header id="header">
    ...
    <div class="col-md-12 custom-overflow cart-container">
          <h4 class="text-uppercase text-left heading-primary custom-paddingV20"><strong>Pagamento</strong></h4>   
            <div class="custom-paddingV20 custom-overflow col-md-6">
                <h5 class="text-uppercase text-left heading-primary custom-paddingV20"><strong>Escolha o método</strong></h5>   
