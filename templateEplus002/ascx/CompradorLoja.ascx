...
<asp:UpdatePanel ID="UpdatePanelComprador" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:RequiredFieldValidator ID="RFVEmail" runat="server"  ControlToValidate="txtEmail" ErrorMessage="Campo Email não pode ficar em branco." Display="None" meta:resourcekey="RFVEmailResource1"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RFVEndereco" runat="server" ControlToValidate="txtEndereco" ErrorMessage="Campo endereço não pode ficar em branco." Display="None" meta:resourcekey="RFVEnderecoResource1"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RFVBairro" runat="server" ControlToValidate="txtBairro" ErrorMessage="Campo bairro não pode ficar em branco." Display="None" meta:resourcekey="RFVBairroResource1"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RFVCidade" runat="server" ControlToValidate="txtCidade" ErrorMessage="Campo cidade não pode ficar em branco." Display="None" meta:resourcekey="RFVCidadeResource1"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RFVDDDTelefone1" runat="server" ControlToValidate="txtDDDTelefone1" ErrorMessage="Campo DDD não pode ficar em branco." Display="None" meta:resourcekey="RFVDDDTelefone1Resource1"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RFVTelefone1" runat="server" ControlToValidate="txtTelefone1" ErrorMessage="Campo telefone não pode ficar em branco." Display="None" meta:resourcekey="RFVTelefone1Resource1"></asp:RequiredFieldValidator>
        
        <div id="CompradorLoja">
            <!--Início da tabela formulário de cadastro -->
            <div align="center">
