<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaPresentesListagemConvidados.aspx.cs" Inherits="CiaShop.Loja.Assets.Templates._1.ListaPresentesListagemConvidados" %><%@ Register Src="ascx/webanalytics.ascx" TagName="webanalytics" TagPrefix="cial" %><%@ Register Src="ascx/header.ascx" TagName="header" TagPrefix="cial" %><%@ Register Src="ascx/footer.ascx" TagName="footer" TagPrefix="cial" %><!DOCTYPE HTML>
