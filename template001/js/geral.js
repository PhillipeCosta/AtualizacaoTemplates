...
jQuery(document).ready(function(){
    ...
    jQuery.fn.extend({restaura_input:function(valorDefault){
	   ...
	   $(".lbl_date input").attr('value', 'Sua data de nascimento');
       $(".lbl_date input").focus(function(){$(this).limpa_input("Sua data de nascimento");});
       $(".lbl_date input").blur(function(){$(this).restaura_input("Sua data de nascimento");});
