  ...
  <div class="container main-container">
    <div class="main-overflow col-md-12">
      <div class="main-overflow main-padding20">
        <h4 class="heading-collection main-padding"><span class="fa fa-file-image-o" style="font-size:20px;"></span> E-mail de divulgação</h4>   
        <ul>
        	<li><span class="fa fa-angle-right"></span>&nbsp;&nbsp;Divulge sua loja para sua rede de contatos.</li>
        </ul>
        <ciac:afiliadodivulgaemail id="affiliateEmail" runat="server"></ciac:afiliadodivulgaemail>
      </div>
    </div>
  </div>
