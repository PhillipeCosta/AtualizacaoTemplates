...
<form id="form2" runat="server">
  ...
  <div class="main-overflow col-md-12">
    <div class="main-padding20">
      <h4 class="heading-collection"><span class="fa fa-users" style="font-size: 20px;"></span> Bem vindo a sessão de afiliados</h4>
    </div>
    <div class="main-overflow main-padding20">
      <a href="#" class="bt btn-secondary" data-toggle="modal" data-target="#myModal">Precisa de ajuda? clique aqui</a>
    </div>    
  </div>
  <div class="main-overflow col-md-12">
    <div class="col-md-3">
      <h4 class="heading-collection text-uppercase text-left main-padding20"><strong>// Primeiros passos</strong></h4>
      <div class="main-overflow main-padding" style="border-bottom: 1px dotted #ececec">
        <h6><strong>Como utilizar seu código de afiliado:</strong></h6>
        <div style="padding: 10px;">
          Para divulgar seu link de afiliado, acrescente no final de cada URL a linha de código abaixo:<br>
          <span style="display: block;">/?campanh_id=codigo_de_afiliado</span>
        </div>
      </div>
      <div class="main-overflow main-padding" style="border-bottom: 1px dotted #ececec">
        <h6><strong>Exemplo de URL para página inicial:</strong></h6>
        <div style="padding: 10px;">
          <span style="display: block;">http://www.loja.com.br/afiliados/Default/?campanha_id=137</span>
        </div>
      </div> 
      <div class="main-overflow main-padding" style="border-bottom: 1px dotted #ececec">
        <h6><strong>Exemplo de URL para departamento:</strong></h6>
        <div style="padding: 10px;">
          <span style="display: block;">http://www.loja.com.br/afiliados/Departamento/902/NOME+DEPTO/?campanha_id=137</span>
        </div>
      </div>   
      <div class="main-overflow main-padding" style="border-bottom: 1px dotted #ececec">
        <h6><strong>Exemplo de URL para produto:</strong></h6>
        <div style="padding: 10px;">
          <span style="display: block;">http://www.loja.com.br/afiliados/produto/160/NOME+PRODUTO/?campanha_id=137</span>
        </div>
      </div>                
    </div>
    <div class="col-md-8">
      <div class="main-overflow main-padding20">
        ...
        <div class="col-md-10">
          <h4 class="heading-collection text-uppercase text-left">Opções de banner</h4>
          <ul class="main-clearPadding main-padding">
          ...
          <div class="main-overflow main-padding pull-right bt btn-primary">
      ...
      <div class="main-overflow main-padding20">
        ...
        <div class="col-md-10">
          <h4 class="heading-collection text-uppercase text-left">Relatório de vendas</h4>
          <ul class="main-clearPadding main-padding">
      ...
      <div class="main-overflow main-padding20">
        ...
        <div class="col-md-10">
          <h4 class="heading-collection text-uppercase text-left">Relatório de visitas</h4>
          <ul class="main-clearPadding main-padding">
      ...
      <div class="main-overflow main-padding20">
        ...
        <div class="col-md-10">
          <h4 class="heading-collection text-uppercase text-left">Relatório de clientes</h4>
          <ul class="main-clearPadding main-padding">
      ...
      <div class="main-overflow main-padding20">
        ...
        <div class="col-md-10">
          <h4 class="heading-collection text-uppercase text-left">E-mail de divulgação</h4>
          <ul class="main-clearPadding main-padding">
