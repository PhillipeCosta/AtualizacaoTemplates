  ...
  <div class="container main-container">
    <div class="main-overflow col-md-12">
      <div class="main-overflow main-padding20">
        <h4 class="heading-collection main-padding"><span class="fa fa-file-text-o" style="font-size:20px;"></span> Relatório de vendas</h4>   
        <ul>
        <li><span class="fa fa-angle-right"></span>&nbsp;&nbsp;Verifique a quantidade de vendas/comissões e pagamentos do seu site/blog.</li>
        </ul>
